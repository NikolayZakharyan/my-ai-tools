...
const TemplateCard: React.FC<TemplateCardProps> = ({ templateItem, order }) => {
  return (
    <div className="bg-white hover:bg-gray-800 shadow-xl hover:shadow-none cursor-pointer w-80 rounded-3xl flex flex-col items-center justify-center transition-all duration-500 ease-in-out">
      ...
      <div className="pt-10 pb-6 w-full px-4 text-center">
        <h1 className="font-medium leading-none text-base tracking-wider text-gray-400">{`${order}. ${templateItem.name}`}</h1>
